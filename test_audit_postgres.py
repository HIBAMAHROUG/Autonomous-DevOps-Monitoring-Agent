...
assert (
    dispatcher._backend()
    is dispatcher._sqlite
)
```

def test_dispatcher_switches_to_postgres_via_env_var(
monkeypatch,
):
monkeypatch.setenv(
"AUDIT_BACKEND",
